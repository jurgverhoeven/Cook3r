...
class Pan:
    ...
    def getMasked(self):
        ...
        blurred = cv2.GaussianBlur(gray, (21,21), cv2.BORDER_DEFAULT)
        ...
        circlesInBlurred = cv2.HoughCircles(blurred, cv2.HOUGH_GRADIENT, 1.4, 120, minRadius=600, maxRadius=900)
