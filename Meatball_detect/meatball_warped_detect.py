...
path = "C:/Users/Jurg Verhoeven/OneDrive - HAN/EVML Cook3r 2021-2022/Lou, Tim, Jurg/Dataset/WarpedMasked/Meatballs"


def meatballCrop(image, x, y, r):
    pt_A = [x - r, y - r]
    pt_B = [x - r, y + r]
    pt_C = [x + r, y + r]
    pt_D = [x + r, y - r]
...
def findMeatballs(image):
    ...
    if circles is not None:
        ...
        for i in circles[0, :]:
            meatballImage = meatballCrop(maskedMeatballs, i[0], i[1], i[2])
            meatball = Food.Meatball(image=meatballImage)
...
for root, dirs, files in os.walk(path):
    ...
    for filename in files:
        ...
        meatballs.extend(findMeatballs(image))

    for meatball in range(len(meatballs)):
        print(meatballs[meatball].area)
        cv2.imwrite("C:/Users/Jurg Verhoeven/Documents/Meatballs/"+str(meatball)+".jpg", meatballs[meatball].image)
